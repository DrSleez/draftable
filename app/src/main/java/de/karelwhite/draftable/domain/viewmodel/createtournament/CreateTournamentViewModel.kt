...
class CreateTournamentViewModel @Inject constructor(
    ...
    // Channel für einmalige Navigationsereignisse
    private val _navigationEvent = Channel<CreateTournamentNavigationEvent>()
    val navigationEvent: Flow<CreateTournamentNavigationEvent> = _navigationEvent.receiveAsFlow()
    ...
    private fun saveTournament() {
        viewModelScope.launch {
            try {
                ...
                _navigationEvent.send(CreateTournamentNavigationEvent.MyTournaments)
            } catch (e: Exception){
